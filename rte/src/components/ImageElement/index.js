...
const ImageElement = function ({
  ...
  const handleDelete = useCallback(() => {
    cbModal({
      component: (props) =>
        DeleteModal({
          ...
          name: element?.attrs?.file?.[rteConfig?.damEnv?.ASSET_NAME_PARAM],
          ...props,
        }),
      modalProps: {
        size: "xsmall",
    ...
    rte?.removeNode,
    element,
    element?.attrs?.file?.[rteConfig?.damEnv?.ASSET_NAME_PARAM],
    props,
  ]);
                ...
                <div className={tooltipclass}>
                  ...
                  {icon && (
                    <Icon
                      ...
                      withTooltip
                      tooltipContent={
                        attrs?.file?.[rteConfig?.damEnv?.ASSET_NAME_PARAM]
                      }
                      tooltipPosition="top"
                    />
                  )}
